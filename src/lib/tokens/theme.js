...
export const colors = {
  ...
  void: `hsl(${HUE}, 12%, 14%)`,
  bg: {
    0: `hsl(${HUE}, ${SAT}, 16%)`, // main background
    1: `hsl(${HUE}, ${SAT}, 18%)`, // sidebar
    2: `hsl(${HUE}, ${SAT}, 20%)`, // header
    3: `hsl(${HUE}, ${SAT}, 22%)`, // deep panels
  ...
  ink: {
    0: 'hsl(35, 15%, 96%)', // primary text
    1: 'hsl(35, 15%, 80%)', // secondary
    2: 'hsl(35, 15%, 60%)', // muted
    3: 'hsl(35, 15%, 40%)', // faint
  },
}
