      ...
      <section id="colors">
        ...
        <div class="space-y-2">
          ...
          <div class="flex gap-0.5">
            {#each ['hsl(183, 12%, 15%)', 'hsl(183, 12%, 17%)', 'hsl(183, 12%, 19%)', 'hsl(183, 12%, 21%)', 'hsl(183, 12%, 23%)', 'hsl(183, 12%, 25%)'] as bg, i}
              <div class="flex-1">
          ...
          <div class="mt-4 flex flex-wrap items-center gap-6">
            {#each [['text-ink-0', 'Primary', 'hsl(183, 10%, 98%)'], ['text-ink-1', 'Secondary', 'hsl(183, 10%, 80%)'], ['text-ink-2', 'Muted', 'hsl(183, 10%, 60%)'], ['text-ink-3', 'Faint', 'hsl(183, 10%, 40%)']] as [cls, label, hex]}
